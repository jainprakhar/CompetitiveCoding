...
int main() 
{ 
	string words[] = {"agafkjfekdcjbkflciafgakbhehiebkffhklgefaklbfjcdb", "fkdfjkfakhaegiaacjj", "giffcihbifdifdiaickalg", "hdhidcceigfidkaladhdciabac" ,"hefgdffkbfjbkiilhldck", "jbbcjgkdgejfaagi"}; 
	printOrder(words, 6, 12); 
	return 0; 
} 
